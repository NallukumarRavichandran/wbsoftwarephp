...
/* ============================================================
   TON TO KG CONVERSION LOGIC FOR PRINT SLIP
   ============================================================ */
$isTon = (stripos($weight_unit, 'TON') !== false);
$display_unit = 'Kg'; // Slip always displays in Kg
...
<div class="slip-container">
    ...
    <table class="weights-table">
        ...
        <tr>
            ...
            <td class="w-sep">:</td>
            <td class="w-val"><?= htmlspecialchars($disp_gross) ?> <?= htmlspecialchars($display_unit) ?></td>
        ...
        <tr>
            ...
            <td class="w-sep">:</td>
            <td class="w-val"><?= htmlspecialchars($disp_tare) ?> <?= htmlspecialchars($display_unit) ?></td>
            <td class="w-dt-lbl">Date :</td>
        ...
        <tr>
            ...
            <td class="w-sep">:</td>
            <td class="w-val"><?= htmlspecialchars($disp_first) ?> <?= htmlspecialchars($display_unit) ?></td>
            <td class="w-dt-lbl">Date :</td>
