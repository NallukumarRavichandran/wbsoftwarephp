...
/* FIXED CAMERA BOX HEIGHT TO PREVENT EXPANDING */
.camera-box{
    margin-top:15px;
    background:#111;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let cam = document.getElementById("cam_live");
    let status = document.getElementById("camera_status");
...
setInterval(function () {
    let cam = document.getElementById("cam_live");
    if (cam) {
        cam.src = "mainform.php?camera=1&t=" + new Date().getTime();
    }
}, 2000);
